...
import com.example.coderescue.navar.network.GeocodeResponse;
import com.example.coderescue.navar.network.RetrofitInterface;
import com.example.coderescue.navar.network.geocode.Location;
import com.example.coderescue.navar.onboarding.DefaultIntro;
import com.example.coderescue.navar.utils.UtilsCheck;
import com.example.coderescue.navar.utils.PermissionCheck;
    ...
    void Geocode_Call(String address){
        ...
        call.enqueue(new Callback<GeocodeResponse>() {
            ...
            public void onResponse(Call<GeocodeResponse> call, Response<GeocodeResponse> response) {
                ...
                List<com.example.coderescue.navar.network.geocode.Result> results=response.body().getResults();
